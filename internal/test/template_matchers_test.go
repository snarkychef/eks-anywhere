  ...
  kubeadmConfigSpec:
    ...
    - path: /etc/test.conf
      owner: root:root`)
		...
		err := os.WriteFile(expectedFile, expectedContent, 0644)
		if err != nil {
...
spec:
  ...
  - name: container1
	...
	// Test case 3: Content field is skipped
	t.Run("content field skipped", func(t *testing.T) {
		actualYAML := []byte(`apiVersion: controlplane.cluster.x-k8s.io/v1beta1
kind: KubeadmControlPlane
metadata:
  name: test
spec:
  kubeadmConfigSpec:
    ...
    - path: /etc/test.conf
      owner: root:root
      content: "actual large content that differs"`)

		expectedFile := filepath.Join(tmpDir, "expected_no_content.yaml")
		expectedContent := []byte(`apiVersion: controlplane.cluster.x-k8s.io/v1beta1
kind: KubeadmControlPlane
metadata:
  name: test
...
func TestAssertYAMLSubset_Negative(t *testing.T) {
	tmpDir := t.TempDir()

	t.Run("missing field in actual should fail", func(t *testing.T) {
		actualYAML := []byte(`apiVersion: v1
kind: Pod
metadata:
  name: test
...
spec:
  replicas: 3`)
	...
	t.Run("type mismatch should fail", func(t *testing.T) {
		actualYAML := []byte(`apiVersion: v1
kind: Pod
metadata:
  name: test
...
spec:
  replicas: 3`)
	...
	t.Run("value mismatch should fail", func(t *testing.T) {
		actualYAML := []byte(`apiVersion: v1
kind: Pod
metadata:
  name: test
...
metadata:
  name: test2`)
	...
	t.Run("array subset mismatch should fail", func(t *testing.T) {
		actualYAML := []byte(`apiVersion: v1
kind: Pod
metadata:
  name: test
...
spec:
  ...
  - name: container2
	...
	t.Run("invalid actual YAML should fail", func(t *testing.T) {
...
metadata:
  name: test`)
	...
	t.Run("missing expected file should fail", func(t *testing.T) {
		actualYAML := []byte(`apiVersion: v1
kind: Pod
metadata:
  name: test`)
