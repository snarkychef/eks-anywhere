...
type ControlPlaneConfiguration struct {
	...
	// during critical control plane operations. When enabled, operations on system resources (such as
	// kube-system RBAC, API service registrations, flow control, etc.) will bypass admission plugins
	// to prevent potential deadlocks or failures during cluster maintenance and upgrades.
	// +optional
